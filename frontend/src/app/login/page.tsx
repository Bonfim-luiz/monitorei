      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 p-12 items-center justify-center">
        <div className="max-w-md text-white">
          ...
          <h2 className="text-4xl font-bold mb-6">
            Bem-vindo de volta ao Monitorei
          </h2>
          
          <p className="text-xl text-primary-100 mb-8">
            Continue acompanhando suas convocações e nunca perca uma oportunidade.
          </p>
          ...
          <div className="bg-white/10 rounded-2xl p-6 backdrop-blur">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <p className="font-semibold text-lg">+500 convocações</p>
                <p className="text-primary-200">Detectadas este mês</p>
              </div>
            </div>
            <p className="text-sm text-primary-200">
              Nosso sistema monitora diariamente os Diários Oficiais para você não perder nenhuma oportunidade.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-gray-600 mt-8">
            Não tem uma conta?{' '}
            <Link href="/cadastro" className="text-primary-600 font-semibold hover:underline">
              Criar conta grátis
            </Link>
          </p>
        </div>
